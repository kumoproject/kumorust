...
const STRINGS: &[(&str, &str, &str)] = &[
    ...
    (
        "settings.subtitle",
        "管理扫描位置和库内容",
        "Manage scan locations and library content",
    ),
    // Library page
    ...
    (
        ...
        "Scanning · {} exe checked · {} games found",
    ),
    (
        "library.scan.done",
        "{} 个游戏 · 已检查 {} 个 exe · {}更新",
        "{} games · {} exe checked · updated {}",
    ),
    (
        "library.empty.no_folders.heading",
        "还没有游戏库",
        "No library yet",
    ),
    (
        "library.empty.no_folders.body",
        "前往设置添加一个索引文件夹",
        "Add an indexed folder in Settings",
    ),
    (
        "library.empty.scanning.heading",
        "正在扫描游戏",
        "Scanning for games",
    ),
    (
    ...
    (
        "library.empty.no_games.body",
        "当前索引文件夹中没有可用的 .exe",
        "No .exe files in the indexed folders",
    ),
    ("library.open_settings", "打开设置", "Open Settings"),
    ("library.refresh", "刷新", "Refresh"),
    (
        "library.refresh.tooltip",
        "重新扫描游戏库",
        "Rescan the library",
    ),
    ...
    (
        ...
        "从这些文件夹中查找 Windows 游戏",
        "Find Windows games in these folders",
    ),
    ("settings.indexed", "已索引文件夹", "Indexed folders"),
    (
        "settings.indexed.description",
        "KumoRust 会扫描这些文件夹中的 Windows 可执行文件",
        "KumoRust scans Windows executables in these folders",
    ),
    (
        "settings.indexed.empty",
        "还没有添加文件夹",
        "No folders added yet",
    ),
    (
        "settings.indexed.empty.caption",
        "使用上方按钮添加后，会自动扫描其中的 .exe 文件",
